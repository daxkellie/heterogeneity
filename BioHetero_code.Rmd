...
```{r}
# Load models
modelb_nonInv_grass_cover <- readRDS("modelb_nonInv_grass_cover")
```
...
# we get what we need - for random effect
V_rep <-post$sd_Replicate__Intercept^2 # making it variance
V_site <-post$sd_ProjectName__Intercept^2 + post$sd_ProjectName__z_nonInv_grass_cover
V_res <- post$sigma^2 
```
...
```{r}
# Load models
modelb_nonInv_forb_cover <- readRDS("modelb_nonInv_forb_cover")
```
...
# we get what we need - for random effect
V_rep <-post$sd_Replicate__Intercept^2 # making it variance
V_site <-post$sd_ProjectName__Intercept^2 + post$sd_ProjectName__z_nonInv_forb_cover
V_res <- post$sigma^2 
```
...
# Save models
# saveRDS(modelb_nonInv_shrub_cover, "modelb_nonInv_shrub_cover")

```

```{r}
# Load models
modelb_nonInv_shrub_cover <- readRDS("modelb_nonInv_shrub_cover")
```
...
# we get what we need - for random effect
V_rep <-post$sd_Replicate__Intercept^2 # making it variance
V_site <-post$sd_ProjectName__Intercept^2 + post$sd_ProjectName__z_nonInv_shrub_cover
V_res <- post$sigma^2 
```
...
# Save models
# saveRDS(modelb_sagebrush_cover, "modelb_sagebrush_cover")

```

```{r}
# Load models
modelb_sagebrush_cover <- readRDS("modelb_sagebrush_cover")
```
...
# Save models
# saveRDS(modelb_inv_ann_grass_cover, "modelb_inv_ann_grass_cover")

```

```{r}
# Load models
modelb_inv_ann_grass_cover <- readRDS("modelb_inv_ann_grass_cover")
```
...
# Save models
# saveRDS(modelb_inv_ann_forb_cover, "modelb_inv_ann_forb_cover")

```

```{r}
# Load models
modelb_inv_ann_forb_cover <- readRDS("modelb_inv_ann_forb_cover")
```
...
# Save models
# saveRDS(modelb_total_foliar_cover, "modelb_total_foliar_cover")

```

```{r}
# Load models
modelb_total_foliar_cover <- readRDS("modelb_total_foliar_cover")
```

### Others

Tim also named Soil Stability Protected Surface Rating vs Soil Stability Unprotected Surface Rating
...
## Viz - Variance Components Bayesian
```{r}
library(ggthemes)
